...
#se filtró y no se pudo subir porque la cantidad de rows no era la mínima
...
test <- read.csv(file.path(dir$processed, "test.csv")) |> select(c(Clase, Dominio, Cuartos, CuartosDormir, TenenciaVivienda, CuotaAmortizacion, ArriendoEst, ArriendoEfec,
                                                                   Npersonas, NpersonasUG, Lindigencia, Lpobreza, Fex_c, Depto, Fex_dpto, 
